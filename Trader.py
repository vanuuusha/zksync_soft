...
class Trader(Metamask):
    ...
    def orbiter(self, count_eth):
        ...
        self.wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]/div[2]/input')))
        self.wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]/div[2]/input')))
        input = self.driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/div[2]/div[2]/div[2]/input')
        input.send_keys(str(count_eth))
        time.sleep(10)
        self.wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/span')))
        self.wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/span')))
        self.driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div/div[2]/div/div/span').click()
        time.sleep(10)
